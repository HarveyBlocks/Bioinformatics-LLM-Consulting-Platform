					...
					<div class="glass">
						<div class="p-3 p-md-4 d-flex flex-column" style="height: 65vh;">
							...
							<div class="d-flex flex-wrap gap-2 mb-2" id="suggestions">
								<span class="chip" data-q="我有RNA-seq数据，从原始数据到差异基因的完整步骤是什么？"> RNA-seq分析流程</span>
								<span class="chip" data-q="分析单细胞转录组数据，推荐最佳工具和分析流程">单细胞工具推荐</span>
								<span class="chip" data-q="如何将转录组和蛋白组数据进行联合分析，并解读结果？"> 多组学数据整合</span>
							</div>

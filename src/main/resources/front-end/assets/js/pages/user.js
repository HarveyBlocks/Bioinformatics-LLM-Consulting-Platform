window.PageUser = {
						...
						<div class="tab-pane fade show active" id="tabProfile" role="tabpanel">
							<div class="card">
								<div class="card-body">
									...
									<hr class="my-4">
									<h2 class="h6 mb-3">生物信息（将同步至服务器）</h2>
									<div class="row g-3">
										<div class="col-md-6">
										...
										<div class="col-md-6">
											<label class="form-label">生物信息偏好（可多选）</label>
										...
										<div class="col-md-12">
											<button class="btn btn-accent" id="saveConsult">保存生物信息问题偏好</button>
										</div>
									</div>
								</div>
							</div>
	...
	mount(root){
		...
		// 生物信息咨询系统 -> /consultation-content/update
		root.querySelector('#saveConsult')?.addEventListener('click', async ()=>{
			...
			if (r.ok){
				App.showToast('已保存生物信息咨询信息','success');
			}else{
